...
% Trang trắng ở mặt sau bìa để in hai mặt.
\pagenumbering{roman}
\thispagestyle{empty}
\null
\newpage

% Trang phân cách không đánh số, đặt trước mục lục.
\thispagestyle{empty}
\vspace*{\fill}
\begin{center}
{\fontsize{36}{44}\selectfont\bfseries BÁO CÁO THỰC TẬP\par}
\end{center}
\vspace*{\fill}
\clearpage
...
% Nhật ký công việc bắt đầu từ mục 1.
