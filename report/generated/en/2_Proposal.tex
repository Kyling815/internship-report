...
\textbf{Flow summary.} CloudFront serves the private S3 frontend and
routes API, chat, and Socket.IO traffic to the ALB. EKS hosts the
backend, chat, dispatcher, worker, and AI services, which use RDS,
Redis, DynamoDB, S3, SQS, Lambda, SES, and SageMaker. GitHub Actions
deploys images, workloads, frontend assets, and CloudFront changes
