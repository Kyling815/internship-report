...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Internship Application Tracker architecture on AWS}]{5-Workshop/infra.png}}
\caption{Internship Application Tracker architecture on AWS}
\end{figure}
